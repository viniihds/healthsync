...
CREATE TABLE USERHEALTH (
    ...
    FOREIGN KEY(CDUSER) REFERENCES USERS(CDUSER)
);
...
INSERT INTO PERMISSION SET PERMISSION.IDPERMISSION = 1; -- usuário
INSERT INTO PERMISSION SET PERMISSION.IDPERMISSION = 2; -- admin
INSERT INTO CATEGORY SET CATEGORY.NMCATEGORY = 'Categoria1';
INSERT INTO MEDICATION SET MEDICATION.CDCATEGORY = 1, MEDICATION.NMMEDICATION = 'Remédio1';